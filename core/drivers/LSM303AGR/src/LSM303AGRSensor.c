...
void LSM303AGR_init() {
	...
	LSM303AGR_writeRegister(0x22, 0x40, 0);
	LSM303AGR_writeRegister(0x24, 0x08, 0);
	LSM303AGR_writeRegister(0x32, 0x10, 0);
	LSM303AGR_writeRegister(0x33, 0x00, 0);
	LSM303AGR_writeRegister(0x30, 0x0A, 0);
