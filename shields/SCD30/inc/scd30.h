...
// #define SCD30_OK 0                 //All is well
// #define SCD30_E_UART -1            //NO UART data coming in
// #define SCD30_E_INVALID_DATA -2    //The UART buffer was not filled
// #define SCD30_E_INVALID_COMMAND -3 //Arduino receives invalid command
// #define SCD30_E_I2C -4             //Arduino reports i2c issue
// #define SCD30_E_INVALID_SENSOR -5  //Arduino received invalid sensor number
// #define SCD30_E_INVALID_TIMEOUT -6 //Arduino received invalid timeout
// #define SCD30_E_NO_NEW_DATA -7     //Arduino does not have new data yet

// #define SCD30_E_MAX_NUMBER 7

// #define SCD30_BAUDRATE 9600

// uint8_t SCD30_Initialize(void);
// int SCD30_getData(uint8_t sensor, uint16_t *co2, float *temp, float *hum);
// int SCD30_calibrate(uint8_t sensor);
// int SCD30_setTimeout(uint8_t sensor, uint16_t seconds);

// int SCD30_poll(uint8_t sensor);
// int SCD30_parse(uint16_t *co2, float *temp, float *hum);
